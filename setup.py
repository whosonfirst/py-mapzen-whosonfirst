...
setup(
    ...
    dependency_links=[
        ...
        'https://github.com/whosonfirst/py-mapzen-whosonfirst-labels/tarball/master#egg=mapzen.whosonfirst.labels-0.02',
        ...
        'https://github.com/whosonfirst/py-mapzen-whosonfirst-validator/tarball/master#egg=mapzen.whosonfirst.validator-0.04',
        ],
    packages=packages,
    scripts=[
        ],
    download_url='https://github.com/mapzen/py-mapzen-whosonfirst-bundle/releases/tag/v0.03',
    license='BSD')
