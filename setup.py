...
setup(
    ...
    install_requires=[
        'mapzen.whosonfirst.concordances>=0.02',
        ...
        'mapzen.whosonfirst.search>=0.10',
        'mapzen.whosonfirst.sources>=0.01',
        'mapzen.whosonfirst.spatial>=0.08',
        'mapzen.whosonfirst.utils>=0.06',
        "mapzen.whosonfirst.validator>=0.08",
        "mapzen.whosonfirst.chatterbox>=0.01",
        "mapzen.whosonfirst.aws>=0.01",
        ],
    dependency_links=[
        'https://github.com/whosonfirst/py-mapzen-whosonfirst-concordances/tarball/master#egg=mapzen.whosonfirst.concordances-0.02',
        ...
        'https://github.com/whosonfirst/py-mapzen-whosonfirst-search/tarball/master#egg=mapzen.whosonfirst.search-0.10',
        'https://github.com/whosonfirst/py-mapzen-whosonfirst-sources/tarball/master#egg=mapzen.whosonfirst.sources-0.01',
        'https://github.com/whosonfirst/py-mapzen-whosonfirst-spatial/tarball/master#egg=mapzen.whosonfirst.spatial-0.08',
        'https://github.com/whosonfirst/py-mapzen-whosonfirst-utils/tarball/master#egg=mapzen.whosonfirst.utils-0.06',
        'https://github.com/whosonfirst/py-mapzen-whosonfirst-validator/tarball/master#egg=mapzen.whosonfirst.validator-0.08',
    ...
    download_url='https://github.com/mapzen/py-mapzen-whosonfirst-bundle/releases/tag/v0.14',
    license='BSD')
