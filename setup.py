...
setup(
    ...
    install_requires=[
        ...
        'mapzen.whosonfirst.spatial>=0.06',
    ...
    dependency_links=[
        ...
        'https://github.com/whosonfirst/py-mapzen-whosonfirst-spatial/tarball/master#egg=mapzen.whosonfirst.spatial-0.07',
    ...
    download_url='https://github.com/mapzen/py-mapzen-whosonfirst-bundle/releases/tag/v0.09',
    license='BSD')
